...
public class Stringhe1 {
	...
	public static void main(String[] args) {
		...
		//dichiaro l'oggetto stringa e lo istanzio - sintassi breve
		String s1 = "Questa è una stringa!";
		System.out.println(s1);
		System.out.println("La stringa è lunga: " + s1.length());
		String s1bis = new String(s1);
		
		//dichiaro l'oggetto stringa e lo istanzio con l'operatore new
		//questa è una particolaritè dell'oggetto String
		String s2 = new String("Anche questa è una stringa con pari dignitè!");
		...
		// non si puè scrivere String s7 = caratteri;
